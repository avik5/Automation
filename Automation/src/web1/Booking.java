...
//	    
 ...
 WebElement element16 = driver.findElement(By.id("JobDetails_problem"));
	 ...
	 WebElement element17 = driver.findElement(By.name("JobDetails[activity_id]"));
	  element17.click();
	   
	    Select se1= new Select (driver.findElement (By.name("JobDetails[activity_id]")));
		   
		 se1.selectByVisibleText("Removal of Ceiling fan");
