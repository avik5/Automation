...
public class login {
	...
	String appURL = "http://4102-01-41.zimmber.com/admin/default/login/";

	// Locators
	private By byEmail = By.id("LoginForm_username");
	private By byPassword = By.id("LoginForm_password");
	...
	public Object[][] loginData() {
		Object[][] arrayObject = getExcelData("C:/Users/DELL/Desktop/Sheet1.xls", "Sheet1");
		return arrayObject;
	}
